...
target_population: int = int(population * (target_percent_vaccinated / 100))
unvaccinated: int = int((target_population * 2)- Doses_administered)
days_left: int = int(unvaccinated // Doses_per_day)
